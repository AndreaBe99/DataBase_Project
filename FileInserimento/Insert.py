...
LOAD DATA LOCAL INFILE 'C://Users/andre/Desktop/InsertMySQLForumFoto.txt';
...
with open("InsertMysqlForumFoto.txt",'w',encoding = 'utf-8') as f:
    for i in range (100000):
        f.write("INSERT INTO provincia (Nome, Sigla) VALUES ('"+ makeString(random.randint(5,50)) + "', '" + makeString(2) + "');\n")
    for i in range (100000):
        f.write("INSERT INTO citta (Nome, ID_Provincia) VALUES ('"+ makeString(random.randint(5,50)) + "', " + str(random.randint(1,100000)) + ");\n")
    for i in range (100000):
        f.write("INSERT INTO luogo (Via, ID_Citta) VALUES ('"+ makeString(random.randint(5,50)) + "', " + str(random.randint(1,100000)) + ");\n")
    for i in range (100000):
        f.write("INSERT INTO studio (Nome) VALUES ('"+ makeString(random.randint(5,50)) + "');\n")
    for i in range (100000):
        f.write("INSERT INTO risiede (ID_Studio, ID_Luogo, NumeroCivico) VALUES (" + str(random.randint(1,100000)) + ", " + str(random.randint(1,100000)) +", " + str(random.randint(0,300)) + ");\n")
    for i in range (100000):
        f.write("INSERT INTO utente (Nome, Cognome, Data, Email, Cellulare, ID_Studio) VALUES ('" + makeString(random.randint(5,50)) + "', '" + makeString(random.randint(5,50)) +"', '" + str(random.randint(1980,2018)) + "-" + str(random.randint(1,12)) + "-" + str(random.randint(1,28)) + "', '" + makeString(random.randint(5,50)) + "', '" + str(random.randint(1,9))+ str(random.randint(1,9))+ str(random.randint(1,9))+ str(random.randint(1,9))+ str(random.randint(1,9))+ str(random.randint(1,9))+ str(random.randint(1,9))+ str(random.randint(1,9))+ str(random.randint(1,9)) + "', " + str(random.randint(1,100000)) + ");\n")
    for i in range (100000):
        f.write("INSERT INTO album (NomeAlbum, Data, ID_Utente) VALUES ('"+ makeString(random.randint(5,50)) + "', '" +  str(random.randint(1980,2018)) + "-" + str(random.randint(1,12)) + "-" + str(random.randint(1,28)) +"', " + str(random.randint(1,100000)) + ");\n")
    for i in range (100000):
        f.write("INSERT INTO categoria (Nome, Descrizione) VALUES ('"+ makeString(random.randint(5,50)) + "', '" + makeString(random.randint(5,50)) + "');\n")
    for i in range (100000):
        f.write("INSERT INTO marca (Nome, Stato)  VALUES ('"+ makeString(random.randint(5,50)) + "', '"+ makeString(random.randint(5,50)) + "');\n")
    for i in range (100000):
        f.write("INSERT INTO macchina (Modello, Sensore, Peso, MaxISO, ID_Marca) VALUES ('"+ makeString(random.randint(5,50)) + "', " + str(random.randint(0,100)) + ", " + str(random.randint(0,78)) + ", " + str(random.randint(0,9000)) + ", " + str(random.randint(1,100000)) + ");\n")
    for i in range (100000):
        f.write("INSERT INTO obiettivo (Modello, OIS, AF, Zoom, ID_Marca) VALUES ('"+ makeString(random.randint(5,50)) + "', " + str(random.randint(0,1)) + ", " + str(random.randint(0,1)) + ", " + str(random.randint(0,1)) + ", " + str(random.randint(1,100000)) + ");\n")
    for i in range (100000):
        f.write("INSERT INTO compatta (ID_Macchina, ID_Obiettivo, ZoomDigitale, StabilizzazioneDigitale) VALUES (" + str(random.randint(1,100000)) + ", " + str(random.randint(1,100000)) + ", " + str(random.randint(0,1)) + ", " + str(random.randint(0,1)) + ");\n")
    for i in range (100000):
        f.write("INSERT INTO reflex (ID_Macchina, MotoreAF) VALUES (" + str(random.randint(1,100000)) + ", " + str(random.randint(0,1)) + ");\n")
    for i in range (100000):
        f.write("INSERT INTO monta (ID_Macchina, ID_Obiettivo, Attacco) VALUES (" + str(random.randint(1,100000)) + ", " + str(random.randint(1,100000)) + ", '" + makeString(random.randint(2,5)) + "');\n")
    for i in range (100000):
        f.write("INSERT INTO fotografia (Descrizione, Data, ID_Album, ID_Categoria, ID_Luogo, ID_Macchina, ID_Obiettivo, LunghezzaFocale, Angolo, Diaframma, Esposizione, ISO, Risoluzione) VALUES ('" + makeString(random.randint(5,140)) + "', '" + str(random.randint(1980,2018)) + "-" + str(random.randint(1,12)) + "-" + str(random.randint(1,28)) + "', "+ str(random.randint(1,100000)) +", "+ str(random.randint(1,100000)) +", "+ str(random.randint(1,100000)) +", "+ str(random.randint(1,100000)) +", "+ str(random.randint(1,100000)) +", "+ str(round(random.uniform(1,3), 1)) +", "+ str(random.randint(2,220)) +", "+ str(round(random.uniform(1,3), 1)) +", "+ str(random.randint(-1000,30)) +", "+str(random.randint(100,9000)) +", "+ str(random.randint(360,1080)) +");\n")
    for i in range (100000):
        f.write("INSERT INTO voto (ID_Utente, ID_Foto, Voto, Descrizione) VALUES (" + str(random.randint(1,100000)) + ", " + str(random.randint(1,100000)) + ", " + str(random.randint(0,10)) + ", '" + makeString(random.randint(10,140)) + "');\n")
...
mongoimport --db ForumFoto --collection "Provincia" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoProvincia.json"
mongoimport --db ForumFoto --collection "Citta" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoCitta.json"
mongoimport --db ForumFoto --collection "Luogo" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoLuogo.json"
mongoimport --db ForumFoto --collection "Studio" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoStudio.json"
mongoimport --db ForumFoto --collection "Risiede" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoRisiede.json"
mongoimport --db ForumFoto --collection "Utente" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoUtente.json"
mongoimport --db ForumFoto --collection "Album" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoAlbum.json"
mongoimport --db ForumFoto --collection "Categoria" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoCategoria.json"
mongoimport --db ForumFoto --collection "Marca" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoMarca.json"
mongoimport --db ForumFoto --collection "Obiettivo" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoObiettivo.json"
mongoimport --db ForumFoto --collection "Macchina" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoMacchina.json"
mongoimport --db ForumFoto --collection "Compatta" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoCompatta.json"
mongoimport --db ForumFoto --collection "Reflex" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoReflex.json"
mongoimport --db ForumFoto --collection "Monta" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoMonta.json"
mongoimport --db ForumFoto --collection "Fotografia" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoFotografia.json"
mongoimport --db ForumFoto --collection "Voto" --drop --type json --file "C:\Users\andre\Google Drive\Tor Vergata\Secondo Anno\Basi di Dati\ForumFotografie\FileInserimento\MongoInsert\MongoVoto.json"
